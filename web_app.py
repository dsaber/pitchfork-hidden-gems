...
def predict():
    try:
        ...
        log_prob, imputed_score = mp.predict_one(
            text, tfidf, logreg, scoring_scale, p4k_scoring_map)
    except:
        imputed_score = ''
...
if __name__ == '__main__':
    ...
    tfidf, logreg, p4k_scoring_map, scoring_scale = cPickle.load(
        open('tfidf_logreg_maps.pkl', 'r'))
