...
def predict_one(review_text, tfidf, logreg,
                scale, scoring_map, default_scale=default_scale):
    # my model was trained on reviews,
    # so it doesn't really work well with tweet-sized
    ...
    if len(review_text) > 1000:
        ...
        return raw_log_prob, ms.map_to_scoring_map((10*raw_log_prob),
                                                   scale,
                                                   scoring_map)
    else:
