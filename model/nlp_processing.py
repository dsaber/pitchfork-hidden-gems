...
def produce_sentiment_data(in_df, neg_thresh=6.0,
                           pos_thresh=8.0, reviewer='All',
                           genre='All'):
    """This function is used to produce positive and
    negative data sets (i.e., DataFrames) that are going to be
    used in model-building. The reviewer and genre fields are
    optional, but depending on the circumstances, can be useful
    to gain deeper understanding into a specific critic's
    writing/feelings about a particular genre"""
...
def find_significant_words(tfidf_vocab, logreg_coefs,
                           feature_vector, best_or_worst='best'):
    result = []
