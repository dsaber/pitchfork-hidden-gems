...
if __name__ == '__main__':
    ...
    tfidf = nlpp.build_cv_or_tfidf(neg['Content'], pos['Content'], 'TFIDF', {
                                   'ngram_range': (1, 3), 'min_df': 9}, None)
    ...
    print 'reordering sentiment analysis scores \
           to fit Pitchfork scoring distribution...'
    ...
    print 'producing scoring map for Pitchfork score \
           and condensed data representation for my score...'
    ...
    print 'saving data to SQL -- this is going to \
           form the foundation of our web app...'
    engine = sqlalchemy.create_engine(
        'postgresql://postgres:@localhost/pitchfork')
    df.to_sql('review', engine, if_exists='replace')

    print 'pickling TF-IDF and Logistic Regression model...'
    cPickle.dump((tfidf, logreg, p4k_scoring_map, my_score_scale),
                 open('tfidf_logreg_maps.pkl', 'w'))
